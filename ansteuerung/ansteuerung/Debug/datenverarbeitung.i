...
# 24 ".././datenverarbeitung.c" 2


extern volatile float geschwindigkeit;
extern volatile float drehzahl;

uint16_t nennspannung = 48000;
uint16_t maxspannung = 56000;
...
char geschwindigkeits_regulierung(char adc_wert)
{
 ...
 if (drehzahl_regelung >= 5000)
 {
  drehzahl_regelung = 5000;
 }


 kennlinie_voltage = (float)(drehzahl_regelung/106);
 ...
 if (kennlinie_voltage >= 40 && ges_spannung_regelung <=44000)
 {
...
# 112 ".././datenverarbeitung.c"
 ...
 {
  if (kennlinie_wert >= (255-angleich_gerade_gas))
  {
   kennlinie_wert = (255-angleich_gerade_gas);
  }
  else if (kennlinie_wert <= (0+angleich_gerade_bremsen))
  {
  ...
  else if (adc_wert < (kennlinie_wert-angleich_gerade_bremsen))
  {
